...
players = ["x", "o"]
player = random.choice(players)
# 2D list to track the buttons
buttons= [[0,0,0],
          [0,0,0],
          [0,0,0]]
label = Label(text= player + " turn", font=("Comic Sans", 40))
label.pack(side="top")

reset_button = Button(text="Restart", font=("Comic Sans", 20), command=new_game)
...
for row in range(3):
    for col in range(3):
        buttons[row][col] = Button(frame, text="", font=("Comic Sans", 40), width=5, height=2,
